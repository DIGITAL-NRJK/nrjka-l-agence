...
// Désabonnement en un clic : GET /api/newsletter/unsubscribe?token=…
...
const page = (locale: string, ok: boolean) => {
  ...
  const msg = ok
    ? en
      ? 'You will no longer receive the NRJKA newsletter. Sorry to see you go!'
      : 'Vous ne recevrez plus la newsletter NRJKA. À bientôt peut-être !'
    : en
